...
def hertz_three_sided_pyramid(E, delta, alpha, nu, contact_point=0,
                              baseline=0):
    """Hertz model for three sided pyramidal indenter (Bilodeau, 1992)

    F =  0.8887*tan(alpha) * E/(1-nu²)  * (delta-contact_point)^(2) + baseline
    ...
    alpha: float
        face angle of a pyramid [degrees]
    nu: float
...
valid_axes_y = ["force"]
doc = hertz_three_sided_pyramid.__doc__
